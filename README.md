...
- I then proceeded to utilize Python libraries such as **Matplotlib**, **Seaborn**, and **Numpy** in order to represent, manipulate and style the information inside of the DataFrame.
